...
مرحلهٔ ۱ پایهٔ اجرایی است؛ زیرساخت مرحلهٔ ۲ پیاده‌سازی شده و شواهد پذیرش آن در `docs/stages/02-infrastructure.md` ثبت می‌شود. مراحل ۳ تا ۲۰ برنامه‌ریزی‌شده‌اند.
