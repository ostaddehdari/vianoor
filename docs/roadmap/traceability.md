...
| R04-01 | ایمیل/رمز               | 4     | ثبت‌نام تا خروج، token reuse، enumeration و rate limit      | planned    |
| R04-02 | تأیید ایمیل             | 4     | ثبت‌نام تا خروج، token reuse، enumeration و rate limit      | planned    |
| R04-03 | بازیابی                 | 4     | ثبت‌نام تا خروج، token reuse، enumeration و rate limit      | planned    |
| R04-04 | Argon2id                | 4     | ثبت‌نام تا خروج، token reuse، enumeration و rate limit      | planned    |
| R04-05 | نشست و rotation         | 4     | ثبت‌نام تا خروج، token reuse، enumeration و rate limit      | planned    |
| R04-06 | محدودیت تلاش            | 4     | ثبت‌نام تا خروج، token reuse، enumeration و rate limit      | planned    |
