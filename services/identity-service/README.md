...
مالکیت: حساب، اعتبارنامه، نشست، روش ورود و MFA

Database: `identity_db`؛ role: `identity_app`. هیچ migration نمایشی اجرا نمی‌شود.

از ریشه: `npm run build:packages` سپس `npm run dev --workspace @vianoor/identity-service`. پورت پیش‌فرض 4101.
