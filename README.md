...
## مرحلهٔ ۴ — هویت ایمیلی

ثبت‌نام، ورود، تأیید ایمیل، بازیابی رمز و امنیت نشست در شاخهٔ `stage/04-identity`. مسیر امنیت حساب `/fa/account/security` و فرم ورود `/fa/auth/login` است. فعال‌سازی backend و SMTP لازم است؛ پیش‌نمایش داشبوردها هنوز دادهٔ نمونه دارند. [راهنمای نصب و محدودیت‌ها](docs/stages/04-identity.md).
